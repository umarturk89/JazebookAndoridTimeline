...
namespace WoWonder.Activities.SettingsPreferences.Support
{
    ...
    public class Support_Activity : AppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                var view = MyContextWrapper.GetContentView(this, Settings.Lang,
                    Resource.Layout.Settings_Support_Layout);
                if (view != null)
                    SetContentView(view);
                else
                    SetContentView(Resource.Layout.Settings_Support_Layout);
                ...
                var ff = FragmentManager.BeginTransaction()
                    .Replace(Resource.Id.content_frame, new Settings_Support_PrefsFragment(this)).Commit();
            }
            catch (Exception e)
            {
