...
namespace WoWonder.Activities.SettingsPreferences.Privacy
{
    ...
    public class Privacy_Activity : AppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                SetContentView(Resource.Layout.Settings_Privacy_Layout);
                ...
                var ff = FragmentManager.BeginTransaction().Replace(Resource.Id.content_frame, new Settings_Privacy_PrefsFragment(this)).Commit();
            }
            catch (Exception e)
            {
